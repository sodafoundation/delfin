...
class NaviHandler(object):
    ...
    def login(self, host_ip=None):
        ...
        except exception.ConnectTimeout as e:
            raise e
    ...
    def get_agent(self):
        """get agent info"""
        return self.get_resources_info(self.GET_AGENT_API,
                                       self.arrange_resource_obj,
                                       return_value={})

    def get_domain(self):
        """get domain info"""
        return self.get_resources_info(self.GET_DOMAIN_API,
                                       self.arrange_domain_obj,
                                       return_value={})

    def get_pools(self):
        """get storage pools info"""
        return self.get_resources_info(self.GET_STORAGEPOOL_API,
                                       self.arrange_resource_list,
                                       return_value=[])

    def get_disks(self):
        """get storage disks info"""
        return self.get_resources_info(self.GET_DISK_API,
                                       self.arrange_resource_list,
                                       return_value=[])

    def get_raid_group(self):
        """get storage raids info"""
        return self.get_resources_info(self.GET_RAIDGROUP_API,
                                       self.arrange_raid_list,
                                       return_value=[])

    def get_pool_lun(self):
        """get storage luns info"""
        return self.get_resources_info(self.GET_LUN_API,
                                       self.arrange_resource_list,
                                       return_value=[])

    def get_all_lun(self):
        """get all luns info"""
        return self.get_resources_info(self.GET_GETALLLUN_API,
                                       self.arrange_lun_list,
                                       return_value=[])
    ...
    def get_resources_info(self, obj_url, arrange_type, return_value=None):
        try:
            command_str = obj_url % {'host': self.navi_host}
            result = self.navi_exe(command_str.split())
            if result:
                return_value = arrange_type(result)
        except Exception as e:
            LOG.error("get resources info error: %s", six.text_type(e))
            raise e
        return return_value
