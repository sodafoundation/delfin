...
HPE3PAR_ALERT_CODE = {
    ...
    '0x0030003': 'Host [[sw_port]] experienced over 50 CRC errors (<count>) in 24 hours',
    ...
    '0x00e001f': '"servicemag resume" operation has passed with dismissed disks',
    '0x00e0020': '"servicemag resume" operation has passed without dismissing any disks',
    '0x00e0021': '"servicemag resume" operation has failed with no error message',
    '0x00e0022': '"servicemag resume" operation has failed to admit disk',
    '0x00e0023': '"servicemag resume" operation has failed unrecoverable disk',
    '0x00e0024': '"servicemag resume" operation has failed to relocate_chunklets',
    ...
    '0x00e0029': 'System manager cannot start up, waiting for nodes to recover',
    ...
    '0x00e002d': 'System manager cannot start up, TOC quorum found, incomplete powerfail',
    '0x00e002e': 'System manager cannot start up, TOC quorum found, waiting for nodes to recover',
    '0x00e002f': 'System manager cannot start up, waiting for nodes to recover',
    ...
    '0x0150021': 'Connection has been reestablished to the security syslog server.',
    ...
    '0x01a0057': 'Node rescue detected that rescuee node has an incompatible board series',
    ...
    '0x01e0006': 'servicemag failed to dismiss PD: cage <cageid>, mag <magid>, '
    ...
    '0x025000c': 'Replication resources restored - Group transition from Logging failure',
    ...
    '0x03b0004': 'Node drive is encrypted but encryption is not enabled on the system',
    '0x03b0005': 'Encryption is enabled on the system but the node drive is not encrypted',
    ...
    '0x03b000b': 'Periodic /proc/mdstat Monitoring Detected Degraded Node Drive Raid',
    ...
    '0x0960003': 'Vasa Provider migration failed due to Certificate mode migration',
    '0x0960004': 'Vasa Provider migration failed while updating config file',
    '0x0960005': 'VASA provider could not start because of issues with the VASA Certificate',
