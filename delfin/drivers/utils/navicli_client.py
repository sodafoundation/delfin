...
class NaviClient(object):
    ...
    EXCEPTION_MAP = {
        'Caller not privileged': exception.InvalidUsernameOrPassword,
        'Security file not found': exception.InvalidUsernameOrPassword,
        'error occurred while trying to connect':
            exception.ConnectTimeout,
        'connection refused': exception.ConnectTimeout,
