...
global_opts = [
    ...
    cfg.StrOpt('delfin_api_topic',
               default='delfin',
               help='The topic api manager nodes listen on.'),
    cfg.StrOpt('delfin_manager',
               default='delfin.api_manager.manager.APIManager',
               help='Full class name for the api server manager.'),
