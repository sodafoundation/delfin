...
CONTROLLERS_DATA = [
    ...
    {'name': 'SP3', 'storage_id': '12345', 'native_controller_id': 'SP3',
     'status': 'fault', 'location': 'SP3', 'soft_version': 'N/A'},
    {'name': 'SP4', 'storage_id': '12345', 'native_controller_id': 'SP4',
     'status': 'fault', 'location': 'SP4', 'soft_version': 'N/A'}]
...
Command completed successfully.\r
(null)@(null) ODSP CLI> """
DISKS_DATA = [{'name': 'SYS-Disk-7:1:1:1', 'storage_id': '12345',
               'native_disk_id': 'SYS-Disk-7:1:1:1',
               'serial_number': '18311E8D2787', 'manufacturer': 'ATA',
               'model': 'Micron_5200_MTFDDAK960TDD', 'firmware': 'U004',
               'location': 'SYS-Disk-7:1:1:1', 'speed': 0,
               'capacity': 958851448832.0, 'status': 'normal',
               'physical_type': 'ssd', 'logical_type': 'unknown'},
              {'name': 'SYS-Disk-7:1:1:2', 'storage_id': '12345',
               'native_disk_id': 'SYS-Disk-7:1:1:2',
               'serial_number': '18311E8D2C03', 'manufacturer': 'ATA',
               'model': 'Micron_5200_MTFDDAK960TDD', 'firmware': 'U004',
               'location': 'SYS-Disk-7:1:1:2', 'speed': 0,
               'capacity': 958851448832.0, 'status': 'normal',
               'physical_type': 'ssd', 'logical_type': 'unknown'}]
...
Command completed successfully.\r
(null)@(null) ODSP CLI> """
STORAGE_DATA = {'name': '0x00b34202-fea90000-fa41e0d6-ded905a8',
                'vendor': 'MacroSAN', 'status': 'abnormal',
                'serial_number': '0x00b34202-fea90000-fa41e0d6-ded905a8',
                'firmware_version': 'V2.0.14T04',
                'raw_capacity': 1917702897664.0,
                'total_capacity': 7670811590656.0,
                'used_capacity': 1031865892864.0,
                'free_capacity': 6638945697792.0}
STORAGE_TWO_DATA = {'name': 'Storage-1', 'vendor': 'MacroSAN',
                    'status': 'abnormal',
                    'serial_number': '0x50b34200-0b750056-42ab74ff-6265d80e',
                    'firmware_version': 'V2.0.14T04',
                    'raw_capacity': 1917702897664.0,
                    'total_capacity': 7670811590656.0,
                    'used_capacity': 1031865892864.0,
...
class test_macro_san_driver(TestCase):
    ...
    def test_init(self):
        MsHandler.do_exec_shell = mock.Mock(
            return_value={""})
    ...
    def test_list_controllers(self):
        SSHPool.do_exec_shell = mock.Mock(
            side_effect=[VERSION_INFO, HA_STATUS])
    ...
    def test_list_storage_hosts_old(self):
        SSHPool.do_exec_shell = mock.Mock(
            side_effect=[UNKNOWN_COMMAND, INITIATOR_INFO, HOSTS_INFO])
