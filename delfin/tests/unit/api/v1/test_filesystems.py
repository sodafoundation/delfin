...
class TestFilesystemController(test.TestCase):
    ...
    def test_list(self):
        ...
        req = fakes.HTTPRequest.blank('/v1/filesystems')
            ...
            "filesystems": [
                {
                    ...
                    "name": "004DF",
                    "native_filesystem_id": "5f5c806d-2e65-473c-b612-345ef43f0642",
                    "type": "type_d",
                    "status": "connected",
    ...
    def test_show(self):
        self.mock_object(
            db, 'filesystem_get',
            fakes.fake_filesystem_show)
        req = fakes.HTTPRequest.blank(
            '/v1/filesystems/d7fe425b-fddc-4ba4-accb-4343c142dc47')
