...
from delfin.task_manager.scheduler.schedulers.telemetry.failed_performance_collection_handler import FailedPerformanceCollectionHandler
...
class PerformanceCollectionHandler(object):
    ...
    def _start_failed_task_handling(self, ctx, storage_id, args, start_time,
                                    end_time):
