...
from dolphin import context, db, exception
...
def build_storage(storage):
    ...
    #     'total_capacity': storage.get('total_capacity'),
    #     'used_capacity': storage.get('used_capacity'),
    #     'free_capacity': storage.get('free_capacity'),
...
class StorageController(wsgi.Controller):
    def __init__(self):
        super(StorageController, self).__init__(None)
        self.id = None
        self.name = None
    ...
    def __create_body(self, body):
        registerctrl = StorageController()
    ...
    def index(self, req):
        ...
        print('get storage succes')
        storages_dict = build_storages(storage_all)
        print(storages_dict)
