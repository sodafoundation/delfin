...
from dolphin.drivers.huawei.oceanstor.oceanstor import OceanStorDriver, consts
from dolphin.drivers.huawei.oceanstor.rest_client import RestClient
...
class TestOceanStorStorageDriver(TestCase):
    ...
    def test_list_storage_pools(self):
        ...
        with mock.patch.object(RestClient, 'get_all_pools',
                               side_effect=exception.DolphinException):
            with self.assertRaises(Exception) as exc:
