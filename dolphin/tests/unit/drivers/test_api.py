...
import sys
sys.modules['dolphin.cryptor'] = mock.Mock()

from dolphin.drivers.api import API
from dolphin.drivers.fake_storage import FakeStorageDriver
...
class TestDriverAPI(TestCase):
    ...
    @mock.patch('dolphin.db.storage_create')
    @mock.patch('dolphin.db.access_info_create')
    @mock.patch('dolphin.db.storage_get_all')
    ...
    @mock.patch('dolphin.db.access_info_update')
