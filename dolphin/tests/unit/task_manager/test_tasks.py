...
from dolphin.drivers import fake_storage
from dolphin.task_manager.tasks import task
from dolphin.task_manager.tasks.task import StorageDeviceTask
...
pools_list = [{
    ...
    "original_id": "fake_original_id_" + str(id),
...
class TestStorageDeviceTask(test.TestCase):
    ...
    @mock.patch('dolphin.db.access_info_delete')
...
class TestStoragePoolTask(test.TestCase):
    @mock.patch.object(coordination.LOCK_COORDINATOR, 'get_lock')
    @mock.patch('dolphin.drivers.api.API.list_storage_pools')
    @mock.patch('dolphin.db.storage_pool_get_all')
    @mock.patch('dolphin.db.storage_pools_delete')
    @mock.patch('dolphin.db.storage_pools_update')
    @mock.patch('dolphin.db.storage_pools_create')
    ...
    @mock.patch('dolphin.db.storage_pool_delete_by_storage')
...
class TestStorageVolumeTask(test.TestCase):
    ...
    @mock.patch('dolphin.db.volumes_delete')
    @mock.patch('dolphin.db.volumes_update')
    @mock.patch('dolphin.db.volumes_create')
