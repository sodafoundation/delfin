...
from dolphin.api.v1 import router
...
class ExtensionTestCase(test.TestCase):
    def setUp(self):
        ...
        ext_list = CONF.dolphin_api_extension[:]
        fox = ('dolphin.tests.unit.api.extensions.foxinsocks.Foxinsocks')
        if fox not in ext_list:
            ext_list.append(fox)
            self.flags(dolphin_api_extension=ext_list)
