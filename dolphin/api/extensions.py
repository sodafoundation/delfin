...
class ExtensionManager(object):
    ...
    See dolphin/tests/api/extensions/foxinsocks/extension.py for an
    ...
    def __init__(self):
        ...
        self.cls_list = CONF.dolphin_api_extension
    ...
    def _load_extensions(self):
        ...
        old_contrib_path = ('dolphin.api.common.share.contrib.'
                            'standard_extensions')
        new_contrib_path = 'dolphin.api.contrib.standard_extensions'
        if old_contrib_path in extensions:
            LOG.warning('dolphin_api_extension is set to deprecated path: '
                        '%s.',
                        old_contrib_path)
            LOG.warning('Please set your flag or dolphin.conf settings for '
                        'dolphin_api_extension to: %s.', new_contrib_path)
...
class ControllerExtension(object):
    """Extend core controllers of dolphin OpenStack API.

    Provide a way to extend existing dolphin OpenStack API core
    controllers.
    """
...
class ResourceExtension(object):
    """Add top level resources to the OpenStack API in dolphin."""
